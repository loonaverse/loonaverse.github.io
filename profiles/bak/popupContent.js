            ...
            if(this.readyState == 4 && this.status == 200) {
                ...
                if(myObj.tv) {
                    ...
                    for(i=0; i<myObj.tv.length; i++) {
                        ...
                        table_tv+=`<td class="tg-cpu2"><a href="${myObj.tv[i].record[myObj.wd[i].record.length-1]}" target="_blank">Link</a></td>`;
                        table_tv+='</tr>';
                ...
                <br>- <u>Color:</u> ${myObj.color.name} | Hex: ${myObj.color.hex} | RGB: ${myObj.color.rgb}
